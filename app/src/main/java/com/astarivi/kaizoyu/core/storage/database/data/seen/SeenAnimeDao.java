...
public interface SeenAnimeDao {
    ...
    @Transaction
    @Query("SELECT kitsuId FROM seen_anime sa INNER JOIN favorite_anime fa ON sa.favoriteId=fa.id WHERE fa.type=:type")
    List<Integer> getKitsuIdWithRelationType(int type);
}